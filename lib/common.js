...
function tryClaimAuthPrompt(serverUrl, ttlMs = AUTH_MARKER_TTL_MS) {
  ...
  // auto-open is suppressed) while the residual — a prompt owner
  // wx-claiming inside the µs between this read and the rename, yielding
  // one extra tab — is the pre-#10 economics and the same window class as
