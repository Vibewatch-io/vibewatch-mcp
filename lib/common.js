 ...
 * proxy-up): grace-QUALIFIED but identity-MATCHED. The strict
  ...
  for (;;) {
    ...
    if (acquired) {
      ...
      if (gateMode === "bridge") {
        ...
        // satisfied variant matches the gate's graced judgment so a
        // coarse-mtime completed marker actually retires (re-review P1).
